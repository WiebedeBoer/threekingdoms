...
@include('towns.mapmenu')
	...
	@foreach($towns as $town) 
		...
		@else
			<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (silk fabrics)</title><circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(185,63,110)" stroke="black" stroke-width="4" /></a>
			</g>
		@endif
	@endforeach
	</svg>
