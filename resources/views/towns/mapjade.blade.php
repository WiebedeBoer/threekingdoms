...
@include('towns.mapmenu')
	...
	@foreach($towns as $town) 
		...
		@else
			<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (jade burial suit)</title><circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(0,168,107)" stroke="black" stroke-width="4" /></a>
			</g>
		@endif
	@endforeach
	</svg>
